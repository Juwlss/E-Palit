...
public class SelfPostAdapter extends RecyclerView.Adapter<SelfPostAdapter.ImageViewHolder> {

    private Context mContext;
    private List<Upload> mUploads;
//    private OnItemClickListener mListener;

    public SelfPostAdapter(Context mContext, List<Upload> mUploads) {
...
//            condition = itemView.findViewById(R.id.itemCondition);
            postImage = itemView.findViewById(R.id.selfpost);
