                                        ...
                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                            ...
                                            for (DataSnapshot dataSnapshot : snapshot.getChildren()){
                                                ...
                                                if (dataSnapshot.getKey().equals(FirebaseAuth.getInstance().getUid())){
                                                    ...
                                                    Upload upload = new Upload(FirebaseAuth.getInstance().getUid(), urlStrings.toString(), name, rating, Profilepic,itemLocation, itemName, itemCondition, cat1,itemDetails,itemValue,itemPreference,timeLimit,false);
