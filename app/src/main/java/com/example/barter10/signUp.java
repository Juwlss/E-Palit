                ...
                PhoneAuthProvider.getInstance().verifyPhoneNumber(
                        ...
                        new PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
                            ...
                            public void onCodeSent(@NonNull String verification, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken){
                                ...
                                intent.putExtra("mobiles", phoNo.getText().toString());
                                intent.putExtra("verificationsgn", verification);
                                intent.putExtra("fullnamedb",fullname.getText().toString());
                                intent.putExtra("usernamedb",username.getText().toString());
                                intent.putExtra("passwordb",password.getText().toString());
                                intent.putExtra("phoNodb",phoNo.getText().toString());
